            ...
            <?php foreach ($modelsDetalles as $index => $modelDetalle): ?>
                    <div class="row detalle-item"><!-- widgetBody -->
                      ...
                      <div class="col-sm-1 col-xs-12">
                        ...
                        ->textInput(['type'=>'text','width' => '200px', 'data-editando' => 0 ])
                        ->label(false)?>
                      </div>
...
// $( '.table-body' ).on( 'keydown', 'input[id$="precio_pdetalle"]', function( e ) {
//
//   if ($( this ).data('editando') == 0) {
//     $( this ).val('')
//   }
//
//   $( this ).data('editando' , 1)
// });
//
// $( '.table-body' ).on( 'blur', 'input[id$="precio_pdetalle"]', function( e ) {
//   $( this ).data('editando' , 0)
// });
