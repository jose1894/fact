...
/*
  ...
  <!-- <div class="row detalle-item"><!- widgetBody -->
    <div class="col-sm-5 col-xs-12">
      <input id="NotaCredito-index-prod_ddetalle" name="NotaCredito[index]prod_ddetalle" class="form-control">
    </div>
    <div class="col-sm-1 col-xs-12">
      <!-- <?= $form
      ->field($modelDetalle,"[{$index}]cant_pdetalle",[ 'addClass' => 'form-control number-integer'])
        ...
        if (opc == "detalle_pedido") {
          for(deta in data[opc]) {
            let linea  = "<div class=\\"row detalle-item\\"><!- widgetBody -->" +
                           "<div class=\\"col-sm-5 col-xs-12\\">"+
                                "<input id=\\"NotaCredito-" + deta + "-prod_ddetalle\\" name=\\"NotaCredito[" + deta + "]prod_ddetalle\\" class=\\"form-control\\">"+
                            "</div>"+
                         "</div>";
