...
<div class="marca-index">
    ...
    <p>
        <?= Html::a(Yii::t('marca', 'Create make'), ['create', 'asDialog' => 1], ['id' => 'create','class' => 'btn btn-flat btn-success']) ?>
    </p>
        ...
        'columns' => [
            ...
            [
                  ...
                  'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = Url::to(['marca/view','id'=>$model->id_marca]);
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = Url::to(['marca/update','id'=>$model->id_marca]);
                        return $url;
                    }
                    if ($action === 'delete') {
                        $url = Url::to(['marca/delete','id'=>$model->id_marca]);
                        return $url;
                    }
