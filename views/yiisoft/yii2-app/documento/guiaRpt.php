<table style="font-size:12px; padding: 0 20px 0 0">
    ...
    foreach ($guia->detalles as $key => $value) {
        // code...
        echo "<tr>";
        echo "<td style='width:20%; padding:0 7px;'>".trim($value->prodDdetalle->cod_prod)."</td>";
        echo "<td style='  padding:0 3px;' class='left'>". Yii::$app->formatter->asInteger($value->cant_ddetalle) ."</td>";
