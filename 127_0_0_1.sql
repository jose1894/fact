...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-07-2019 a las 19:25:42
...
('Administradores', 1, NULL, NULL, NULL, 1562771725, 1562771725),
('Usuarios', 1, NULL, NULL, NULL, 1562772110, 1562772110);
...
('Administradores', '/admin/assignment/*'),
('Administradores', '/admin/assignment/assign'),
('Administradores', '/admin/assignment/index'),
('Administradores', '/admin/assignment/revoke'),
('Administradores', '/admin/assignment/view'),
('Administradores', '/admin/default/*'),
('Administradores', '/admin/default/index'),
('Administradores', '/admin/menu/*'),
('Administradores', '/admin/menu/create'),
('Administradores', '/admin/menu/delete'),
('Administradores', '/admin/menu/index'),
('Administradores', '/admin/menu/update'),
('Administradores', '/admin/menu/view'),
('Administradores', '/admin/permission/*'),
('Administradores', '/admin/permission/assign'),
('Administradores', '/admin/permission/create'),
('Administradores', '/admin/permission/delete'),
('Administradores', '/admin/permission/index'),
('Administradores', '/admin/permission/remove'),
('Administradores', '/admin/permission/update'),
('Administradores', '/admin/permission/view'),
('Administradores', '/admin/role/*'),
('Administradores', '/admin/role/assign'),
('Administradores', '/admin/role/create'),
('Administradores', '/admin/role/delete'),
('Administradores', '/admin/role/index'),
('Administradores', '/admin/role/remove'),
('Administradores', '/admin/role/update'),
('Administradores', '/admin/role/view'),
('Administradores', '/admin/route/*'),
('Administradores', '/admin/route/assign'),
('Administradores', '/admin/route/create'),
('Administradores', '/admin/route/index'),
('Administradores', '/admin/route/refresh'),
('Administradores', '/admin/route/remove'),
('Administradores', '/admin/rule/*'),
('Administradores', '/admin/rule/create'),
('Administradores', '/admin/rule/delete'),
('Administradores', '/admin/rule/index'),
('Administradores', '/admin/rule/update'),
('Administradores', '/admin/rule/view'),
('Administradores', '/admin/user/*'),
('Administradores', '/admin/user/activate'),
('Administradores', '/admin/user/change-password'),
('Administradores', '/admin/user/delete'),
('Administradores', '/admin/user/index'),
('Administradores', '/admin/user/login'),
('Administradores', '/admin/user/logout'),
('Administradores', '/admin/user/request-password-reset'),
('Administradores', '/admin/user/reset-password'),
('Administradores', '/admin/user/signup'),
('Administradores', '/admin/user/view'),
...
(4, '', '', 'MARIANO QUISPE', 'HUAYNA CAPAC', 241, 133, 15, 133, '', 2, 1, 2, 0, 1);
...
(8, 1, 4, '24.00', 0, '0.00', '0.00', '0.00', '0.00'),
(9, 2, 3, '40.00', 0, '0.00', '0.00', '0.00', '0.00'),
(10, 1, 6, '90.00', 0, '0.00', '0.00', '0.00', '0.00'),
(12, 1, 5, '24.00', 0, '0.00', '0.00', '0.00', '0.00');
...
(1, '0000000001', '2019-06-21', 4, 2, 1, 1, 1, 0, 0, 2, 0, 'N', '111111'),
(3, '0000000001', '2019-06-21', 4, 2, 1, 1, 1, 0, 0, 2, 1, 'N', ''),
(4, '0000000002', '2019-06-21', 4, 2, 1, 1, 1, 0, 0, 2, 0, 'N', ''),
(5, '0000000005', '2019-06-21', 4, 2, 1, 1, 1, 0, 0, 2, 0, 'N', '78943');
...
--
ALTER TABLE `sucursal`
  MODIFY `id_suc` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID UNICO';
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `empresa` FOREIGN KEY (`empresa`) REFERENCES `empresa` (`id_empresa`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `sucursal` FOREIGN KEY (`sucursal`) REFERENCES `sucursal` (`id_suc`) ON DELETE CASCADE ON UPDATE NO ACTION;
